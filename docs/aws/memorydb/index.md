...
See [MemoryDBConfig governance](./memorydbconfig.md#governance) for full cascade semantics.
...
MemoryDB is AWS-specific. GCP provides Memorystore for Redis; Azure provides Cache for Redis. Kropath will add `GCPMemoryStoreInstance` and `AzureCacheForRedis` RGDs in future releases.
...
- **Governance cascade details:** [MemoryDBConfig governance](./memorydbconfig.md#governance)
- **Naming template syntax:** [Naming Template — Dynamic Tags](../resources/naming-template-dynamic-tags.md)
