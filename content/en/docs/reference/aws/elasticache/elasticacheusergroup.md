---
title: ElastiCacheUserGroup — User Grouping for RBAC
description: "The `ElastiCacheUserGroup` resource groups `ElastiCacheUser` resources to implement role-based access control (RBAC) on Redis and Valkey caches."
doc_type: reference
---
