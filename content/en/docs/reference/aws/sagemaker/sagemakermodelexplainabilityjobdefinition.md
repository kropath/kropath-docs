---
title: SageMakerModelExplainabilityJobDefinition — Model Explainability Monitoring
description: "The `SageMakerModelExplainabilityJobDefinition` resource specifies configuration for model explainability analysis to understand model predictions."
doc_type: reference
---
# SageMakerModelExplainabilityJobDefinition — Model Explainability Monitoring

The `SageMakerModelExplainabilityJobDefinition` resource specifies configuration for model explainability analysis to understand model predictions.
...
| Field | Type | Default | Purpose |
|---|---|---|---|
| `modelExplainabilityAppSpecification.imageUri` | string | required | Container image for explainability analysis |
| `modelExplainabilityBaselineConfig.baseliningJobName` | string | optional | Baseline job reference for drift comparison |
...
kind: SageMakerModelExplainabilityJobDefinition
metadata:
  name: model-explainability-monitoring
  namespace: ml-team
spec:
  ...
  tags:
    MonitoringType: model-explainability
```
