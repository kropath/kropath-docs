---
title: SageMakerModelPackageGroup — Model Registry Container
description: "The `SageMakerModelPackageGroup` resource is a logical container for organizing versioned model packages in the model registry."
doc_type: reference
---
