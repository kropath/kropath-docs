---
title: SageMakerDataQualityJobDefinition — Data Drift Monitoring
description: "The `SageMakerDataQualityJobDefinition` resource specifies the analysis algorithm and configuration for detecting data drift in endpoint inputs."
doc_type: reference
---
