---
title: SageMakerPipeline — ML Workflow Definition
description: "The `SageMakerPipeline` resource defines an ML workflow as a JSON pipeline definition with steps for training, processing, evaluation, and model registration."
doc_type: reference
---
