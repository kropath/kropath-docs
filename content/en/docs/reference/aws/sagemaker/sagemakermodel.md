---
title: SageMakerModel — ML Model Definition
description: "The `SageMakerModel` resource defines the container image(s) and model artifact location(s) that serve inference requests."
doc_type: reference
---
