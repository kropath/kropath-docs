---
title: SageMakerEndpoint — Managed Inference Hosting
description: "The `SageMakerEndpoint` resource represents a managed compute resource that hosts one or more models for real-time predictions."
doc_type: reference
---
