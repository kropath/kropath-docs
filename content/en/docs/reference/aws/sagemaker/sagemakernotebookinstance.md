---
title: SageMakerNotebookInstance — Managed Jupyter Environment
description: "The `SageMakerNotebookInstance` resource represents an EC2-backed managed Jupyter notebook environment for interactive ML development."
doc_type: reference
---
