---
title: CloudTrailTrail — API Activity Logging
description: CloudTrailTrail is a kropath resource for creating and managing AWS CloudTrail trails.
doc_type: reference
---
