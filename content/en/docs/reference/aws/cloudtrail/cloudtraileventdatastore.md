---
title: CloudTrailEventDataStore — Event Querying with CloudTrail Lake
description: CloudTrailEventDataStore is a kropath resource for creating and managing AWS CloudTrail Lake event data stores.
doc_type: reference
---
