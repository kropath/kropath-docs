...
description: The AWS CloudTrail family within kropath provides abstractions for managing Amazon CloudTrail resources for comprehensive API activity logging.
doc_type: reference
weight: 90
---
# AWS CloudTrail
