---
title: CloudWatchMetricStream — Metric Streaming to Firehose
description: "The `CloudWatchMetricStream` resource creates and manages AWS CloudWatch metric streams in Kubernetes."
doc_type: reference
---
