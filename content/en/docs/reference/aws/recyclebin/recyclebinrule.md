---
title: RecycleBinRule — Retention Rules for EBS Snapshots and AMIs
description: "The `RecycleBinRule` resource creates and manages AWS Recycle Bin retention rules that protect your EBS snapshots and EC2 AMIs from accidental deletion."
doc_type: reference
---
