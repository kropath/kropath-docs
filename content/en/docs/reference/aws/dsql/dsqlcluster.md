---
title: DSQLCluster — Creating and Managing Aurora DSQL Clusters
description: "The `DSQLCluster` resource represents a single Aurora DSQL cluster — a serverless, multi-Region, PostgreSQL-compatible relational database."
doc_type: reference
---
