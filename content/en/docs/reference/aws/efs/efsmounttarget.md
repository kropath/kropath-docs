---
title: EFSMountTarget — Network Connectivity for NFS Access
description: "The `EFSMountTarget` resource provides network connectivity to an EFS file system by creating an Elastic Network Interface (ENI) in a specific VPC subnet."
doc_type: reference
---
