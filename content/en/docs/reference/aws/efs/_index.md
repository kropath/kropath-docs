...
description: The AWS EFS family within kropath provides abstractions for managing Amazon EFS (Elastic File System), a managed, fully elastic, and highly available shared file storage service.
doc_type: reference
weight: 210
---
