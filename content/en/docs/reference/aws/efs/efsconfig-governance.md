---
title: EFSConfig — Governance Profiles for EFS
description: "`EFSConfig` CRs define per-profile governance policies that platform engineers apply to the EFS family."
doc_type: reference
---
