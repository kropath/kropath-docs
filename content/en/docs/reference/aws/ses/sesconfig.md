---
title: SESConfig — Governance Reference
description: "`SESConfig` is a Kubernetes CRD that platform teams use to enforce policies across all SES configuration sets in a namespace or cluster."
doc_type: reference
---
...
- [SES Resource Family Overview](./_index.md)
