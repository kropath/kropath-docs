---
title: SESConfigurationSet — User Guide
description: "`SESConfigurationSet` is a Kubernetes resource that provisions AWS SES v1 configuration sets for email sending workflows."
doc_type: reference
---
