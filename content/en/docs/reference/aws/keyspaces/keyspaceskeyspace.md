---
title: KeyspacesKeyspace
description: "`KeyspacesKeyspace` is a Kubernetes resource that represents an Amazon Keyspaces keyspace — a top-level namespace that groups CQL tables."
doc_type: reference
---
# KeyspacesKeyspace
