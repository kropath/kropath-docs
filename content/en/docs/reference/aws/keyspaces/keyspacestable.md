---
title: KeyspacesTable
description: "`KeyspacesTable` is a Kubernetes resource that represents an Amazon Keyspaces CQL table."
doc_type: reference
---
# KeyspacesTable
...
```
You selected provisioned mode but didn't specify read capacity. Provide a value (min 100).
