...
description: "The `APIGateway` family provides resources for AWS API Gateway REST APIs, including API configuration, REST API creation and management, authorizers, deployment, and access control."
doc_type: reference
weight: 10
---
