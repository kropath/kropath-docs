---
title: SecretsManagerSecret — Creating and Managing Secrets
description: "The `SecretsManagerSecret` resource represents a single secret in AWS Secrets Manager."
doc_type: reference
---
