...
description: AWS Secrets Manager resources in kropath enable you to create, manage, and rotate secrets with encryption, cross-region replication, and governance controls.
doc_type: reference
weight: 480
---
# AWS Secrets Manager
