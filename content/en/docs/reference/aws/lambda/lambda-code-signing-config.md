---
title: LambdaCodeSigningConfig — Code Provenance and Validation
description: "The `LambdaCodeSigningConfig` resource defines code signing policies for Lambda functions."
doc_type: reference
---
