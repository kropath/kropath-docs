---
title: IAMUser — Operator Access
description: "The `IAMUser` resource creates IAM users for human operators who need to access your AWS environment using the console or programmatic credentials."
doc_type: reference
---
