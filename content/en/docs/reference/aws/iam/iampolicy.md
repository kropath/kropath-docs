---
title: IAMPolicy — Reusable Managed Policies
description: "The `IAMPolicy` resource creates AWS IAM managed policies — reusable permission sets that can be attached to multiple roles, groups, or users."
doc_type: reference
---
