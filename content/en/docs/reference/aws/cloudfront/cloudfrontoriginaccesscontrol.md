---
title: CloudFrontOriginAccessControl — Restrict Origin Access
description: "`CloudFrontOriginAccessControl` (OAC) restricts access to your origin so only CloudFront can reach it."
doc_type: reference
---
