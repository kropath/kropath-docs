---
title: CloudFrontConnectionGroup — Multi-Tenant Routing Endpoint
description: "`CloudFrontConnectionGroup` defines a shared routing endpoint and static IP configuration for multi-tenant CloudFront distributions."
doc_type: reference
---
