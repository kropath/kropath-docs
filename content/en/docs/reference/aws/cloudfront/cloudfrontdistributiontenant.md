---
title: CloudFrontDistributionTenant — Multi-Tenant Subscriber
description: "`CloudFrontDistributionTenant` attaches a single customer (tenant) to a multi-tenant CloudFront distribution."
doc_type: reference
---
