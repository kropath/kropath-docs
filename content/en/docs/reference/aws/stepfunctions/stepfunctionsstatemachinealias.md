---
title: StepFunctionsStateMachineAlias — User Guide
description: "`StepFunctionsStateMachineAlias` is a Kubernetes resource that provisions AWS Step Functions aliases for routing traffic between state machine versions."
doc_type: reference
---
