---
title: StepFunctionsStateMachine — User Guide
description: "`StepFunctionsStateMachine` is a Kubernetes resource that provisions AWS Step Functions state machines for serverless workflow orchestration."
doc_type: reference
---
