---
title: DynamoDBConfig — Governance Configuration
description: "The `DynamoDBConfig` resource defines governance profiles that control how DynamoDB tables are created and managed across your organization and namespaces."
doc_type: reference
---
