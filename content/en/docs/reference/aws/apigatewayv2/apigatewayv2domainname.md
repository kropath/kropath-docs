---
title: ApiGatewayV2DomainName — Custom Domain Names
description: "The `ApiGatewayV2DomainName` resource creates custom domain names for APIs, enabling access via branded URLs instead of AWS-managed `execute-api` endpoints."
doc_type: reference
---
