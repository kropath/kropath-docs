---
title: ApiGatewayV2Config — API Gateway V2 Governance
description: "The `ApiGatewayV2Config` resource defines per-environment governance policies for all API Gateway V2 resources."
doc_type: reference
---
