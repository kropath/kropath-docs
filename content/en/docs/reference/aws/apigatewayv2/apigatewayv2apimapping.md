---
title: ApiGatewayV2ApiMapping — Domain Path Routing
description: "The `ApiGatewayV2ApiMapping` resource connects custom domain names to API stages, optionally under a base path prefix."
doc_type: reference
---
