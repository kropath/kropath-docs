---
title: SNSSubscription — Subscribe Endpoints to Topics
description: "The `SNSSubscription` resource binds delivery endpoints (SQS queues, Lambda functions, HTTP/S URLs, email addresses, SMS numbers, Firehose streams, or mobile applications) to SNS topics."
doc_type: reference
---
