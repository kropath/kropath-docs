---
title: AWS EC2Subnet
description: EC2Subnet represents an Amazon EC2 subnet—a logical subdivision of a VPC bound to a single availability zone (AZ).
doc_type: reference
---
# AWS EC2Subnet
...
See [EC2Config](../ec2config.md) for governance policies, [EC2VPC](./ec2vpc.md) for VPC configuration, and [EC2 Family](../_index.md) for other networking resources.
