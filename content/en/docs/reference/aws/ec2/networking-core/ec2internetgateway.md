---
title: AWS EC2InternetGateway
description: EC2InternetGateway represents an Internet Gateway—an AWS resource that enables communication between resources in a VPC and the internet.
doc_type: reference
---
