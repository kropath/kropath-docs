---
title: AWS EC2VPC
description: EC2VPC represents an Amazon Virtual Private Cloud (VPC)—an isolated network environment where you can launch AWS resources.
doc_type: reference
---
# AWS EC2VPC
...
See [EC2Config](../ec2config.md) for governance policies and [EC2 Family](../_index.md) for other networking resources.
