---
title: AWS EC2NATGateway
description: EC2NATGateway represents a NAT Gateway—a managed AWS service that enables instances in a private subnet to initiate outbound IPv4 traffic to the internet while preventing inbound traffic from reaching those instances.
doc_type: reference
---
# AWS EC2NATGateway
