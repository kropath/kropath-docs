...
description: The AWS EC2 family in kropath provides abstractions for managing Amazon Elastic Compute Cloud (EC2) resources and related networking infrastructure.
doc_type: reference
weight: 170
---
# AWS EC2 Family
