---
title: AWS EC2DHCPOptions
description: EC2DHCPOptions represents a DHCP Options Set—a configuration that specifies how DNS resolution and NTP settings are handled for instances within a VPC.
doc_type: reference
---
# AWS EC2DHCPOptions
...
See [EC2VPC](../networking-core/ec2vpc.md) for VPC configuration and [EC2 Family](../_index.md) for related resources.
