---
title: AWS EC2TransitGatewayAttachment
description: EC2TransitGatewayAttachment represents an attachment between a VPC and a Transit Gateway.
doc_type: reference
---
...
See [EC2TransitGateway](./ec2transitgateway.md) for transit gateway configuration and [EC2 Family](../_index.md) for related resources.
