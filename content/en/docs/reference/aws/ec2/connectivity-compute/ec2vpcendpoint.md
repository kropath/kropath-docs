---
title: AWS EC2VPCEndpoint
description: EC2VPCEndpoint represents a VPC Endpoint—a private connection between a VPC and an AWS service or third-party service, eliminating the need for internet gateways, NAT gateways, or direct connections to reach services outside the VPC.
doc_type: reference
---
# AWS EC2VPCEndpoint
