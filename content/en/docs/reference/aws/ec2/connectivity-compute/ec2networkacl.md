---
title: AWS EC2NetworkACL
description: EC2NetworkACL represents a Network Access Control List (NACL)—a stateless firewall that controls inbound and outbound traffic at the subnet level.
doc_type: reference
---
# AWS EC2NetworkACL
