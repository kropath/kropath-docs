---
title: AWS EC2Instance
description: EC2Instance represents an Amazon EC2 instance—a virtual machine running on AWS infrastructure.
doc_type: reference
---
# AWS EC2Instance
...
See [EC2Config](../ec2config.md) for governance, [EC2LaunchTemplate](./ec2launchtemplate.md) for template-based launch, and [EC2 Family](../_index.md) for related resources.
