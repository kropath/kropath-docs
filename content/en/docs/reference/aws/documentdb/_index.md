...
description: The AWS DocumentDB family within kropath provides abstractions for managing Amazon DocumentDB (MongoDB-compatible) database clusters, instances, and network infrastructure.
doc_type: reference
weight: 140
---
# AWS DocumentDB
