...
description: The AWS Elastic Kubernetes Service (EKS) family within kropath provides abstractions for managing Kubernetes cluster lifecycles, compute resources, add-ons, and cluster access.
doc_type: reference
weight: 220
---
