---
title: MWAAConfig — Governance and Compliance Profiles
description: "The `MWAAConfig` resource defines governance policies for all MWAA (Managed Workflows for Apache Airflow) environments in your organization."
doc_type: reference
---
