---
title: RAMConfig — Resource Sharing Governance
description: "`RAMConfig` is a Kubernetes CRD that platform teams use to enforce policies across all AWS Resource Access Manager (RAM) resource shares and permissions in a namespace or cluster."
doc_type: reference
---
