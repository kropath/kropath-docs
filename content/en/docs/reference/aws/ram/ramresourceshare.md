---
title: RAMResourceShare — Sharing AWS Resources Across Accounts
description: "`RAMResourceShare` is a Kubernetes resource that represents an AWS RAM resource share — a bundle of AWS resources, principals, and permissions that enables cross-account access."
doc_type: reference
---
