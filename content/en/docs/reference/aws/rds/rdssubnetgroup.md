---
title: RDSSubnetGroup — Managing VPC Subnet Groups
description: "The `RDSSubnetGroup` resource creates and manages an AWS RDS DB Subnet Group, which determines which VPC subnets (and Availability Zones) your RDS instances and Aurora clusters can be deployed into."
doc_type: reference
---
