---
title: CloudWatchLogsLogGroup — Creating and Managing Log Groups
description: "The `CloudWatchLogsLogGroup` resource represents a single log group in AWS CloudWatch Logs."
doc_type: reference
---
