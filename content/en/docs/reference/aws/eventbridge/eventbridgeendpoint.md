---
title: EventBridgeEndpoint — Global Event Endpoints
description: "The `EventBridgeEndpoint` resource provides automatic multi-region failover for EventBridge event ingestion."
doc_type: reference
---
