---
title: MemoryDBParameterGroup — Engine Tuning Parameters
description: "The `MemoryDBParameterGroup` resource represents a named collection of Redis OSS engine configuration parameters (e.g."
doc_type: reference
---
