---
title: MemoryDBACL — Access Control and User Groups
description: "The `MemoryDBACL` resource represents an access control list (ACL) — a named group of `MemoryDBUser` resources that can be attached to a MemoryDB cluster for authentication and authorization."
doc_type: reference
---
