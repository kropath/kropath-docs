---
title: MemoryDBUser — User Identity and Authentication
description: "The `MemoryDBUser` resource represents a single user identity for MemoryDB cluster authentication."
doc_type: reference
---
