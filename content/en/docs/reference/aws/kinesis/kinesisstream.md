---
title: AWS Kinesis Stream Resource Guide
description: "The `KinesisStream` resource creates and manages AWS Kinesis Data Streams with support for both ON_DEMAND (auto-scaling) and PROVISIONED (manual shard count) capacity modes."
doc_type: reference
---
