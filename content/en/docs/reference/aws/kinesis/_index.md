...
description: AWS Kinesis Data Streams is a serverless, scalable data stream service that captures, processes, and stores data from various sources in real-time.
doc_type: reference
weight: 290
---
