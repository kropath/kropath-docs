---
title: SSMDocument — Operational Runbooks and Automation
description: "The `SSMDocument` resource represents a single AWS Systems Manager document—a runbook, automation script, or command definition used for operational tasks on managed instances or AWS resources."
doc_type: reference
---
