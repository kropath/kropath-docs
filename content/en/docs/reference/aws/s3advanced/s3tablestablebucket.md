---
title: S3TablesTableBucket
description: "`S3TablesTableBucket` is a Kubernetes resource that represents an Amazon S3 Tables table bucket — an Iceberg-native storage container optimized for analytics workloads."
doc_type: reference
---
# S3TablesTableBucket
