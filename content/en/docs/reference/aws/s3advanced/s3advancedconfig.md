---
title: S3AdvancedConfig
description: "`S3AdvancedConfig` is a governance configuration resource that lets you define mandatory and default settings for AWS S3 Advanced services — S3 Tables (Iceberg), S3 Vectors (embedding storage), S3 Files (POSIX file systems), and S3 Control (access points)."
doc_type: reference
---
# S3AdvancedConfig
