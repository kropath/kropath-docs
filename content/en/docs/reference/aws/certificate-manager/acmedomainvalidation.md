---
title: ACMEDomainValidation — ACME Domain Prevalidation
description: "The `ACMEDomainValidation` resource prevalidates domain ownership against an ACME endpoint using DNS (Route 53)."
doc_type: reference
---
