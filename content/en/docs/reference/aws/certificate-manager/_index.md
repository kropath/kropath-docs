---
title: Certificate Manager Family
description: The Certificate Manager family provides abstractions for TLS/SSL certificate lifecycle management and private certificate authority (CA) operations in AWS.
doc_type: reference
weight: 70
---
