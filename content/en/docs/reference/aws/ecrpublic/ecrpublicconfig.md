---
title: ECRPublicConfig — Governance for Public Container Repositories
description: "`ECRPublicConfig` is a governance CRD that platform teams deploy to enforce organization-wide controls on ECR Public repositories."
doc_type: reference
---
