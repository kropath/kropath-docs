---
title: ECR Public — Container Image Publishing to the Public Gallery
description: "ECR Public is a fully managed container image registry service that hosts publicly accessible container images in the [AWS ECR Public Gallery](https://gallery.ecr.aws)."
doc_type: reference
weight: 190
---
